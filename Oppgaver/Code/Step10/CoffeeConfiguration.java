...
public class CoffeeConfiguration {
    ...
    public double getQuantityCoffee() {return quantityCoffee;}

    public void setQuantityCoffee(double quantityCoffee) {this.quantityCoffee = quantityCoffee;}

    public double getQuantityWater() {return quantityWater;}
